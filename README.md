...
имени пользователя из учётной записи ОС — GECOS в формате «Фамилия Имя
Отчество», в приветствии используется второе слово), список задач из
файла, случайную фразу дня и, после истечения времени блокировки, кнопку
«Вперёд!» по центру внизу экрана. Фоном служит случайно выбранное
изображение из настроенного каталога — масштабируется под экран с
сохранением пропорций (cover-fit), а
