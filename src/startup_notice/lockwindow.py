...
def _display_name() -> str:
    ...
    порядку «Фамилия Имя Отчество», поэтому для приветствия берётся
    второе слово (имя), а не первое (фамилия); если слово одно —
    используется оно, а если GECOS не задан — системный логин."""
